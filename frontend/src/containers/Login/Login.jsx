...
const Login = () => {
    ...
    return (
        <form className="Form">
            <b className="Form__title">Login</b>
            <Input
                classList={[]}
                conditions={{
            ...
            <div className="Form__actions">
                <input type="submit" disabled={!usernameValid || !passwordValid} className="Form__submit" onClick={handleLogin} value='Login'/>
                <span onClick={() => history.goBack()} className="Form__cancel">Cancel</span>
            </div>
        </form>
    )
}
