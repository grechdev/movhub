...
const Register = () => {
    ...
    const handleRegister = e => {
        ...
        if (usernameValid && passwordValid && repeatPasswordValid) {
            ...
            .catch(() => {
                ...
                document.querySelector('.Register__username').focus()
            })
        }
    }
    ...
    return (
        <form className='Form'>
            <b className="Form__title">Register</b>
            <Input 
            ...
            <div className="Form__actions">
                ...
                />
                <span onClick={() => history.goBack()} className='Form__cancel' type="submit">Cancel</span>
            </div>
        </form>
    )
}
